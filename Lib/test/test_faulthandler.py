...
from test.support import script_helper, is_android, MS_WINDOWS, threading_helper
import tempfile
import unittest
...
def temporary_filename():
    with tempfile.NamedTemporaryFile(delte_on_close=False) as file:
        # need to be closed for windows
        file.close()
        yield file.name
